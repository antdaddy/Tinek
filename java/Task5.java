...
public class Task5 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (result.equals("ACCESSED") || result.equals("DENIED") || result.equals("FORBIDDEN")) {
                ...
                // Можно добавить обработку "FORBIDDEN", если необходимо
            }
        }
    ...
    public static class Team {
        ...
        public void updateTime(String startTime, String time) {
            int startMinutes = Integer.parseInt(startTime.split(":")[0]) * 60 + Integer.parseInt(startTime.split(":")[1]);
            int minutes = Integer.parseInt(time.split(":")[0]) * 60 + Integer.parseInt(time.split(":")[1]);
            penalty += (minutes - startMinutes + 1440) % 1440; // добавляем разницу во времени, но не более 24 часов
        }
